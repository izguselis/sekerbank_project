"""
Django settings for sekerbank_project project.
...
SECRET_KEY = 'n@==76i*cyh_vp$1050p#0o%b-%(3dg^p*=8^h0(xr^d8di0x@'
...
ROOT_URLCONF = 'sekerbank_project.urls'
...
WSGI_APPLICATION = 'sekerbank_project.wsgi.application'
